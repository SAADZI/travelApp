...
<View className="absolute m-4 z-40 bg-primary rounded-full p-1"><Ionicons onPress={()=>navigation.goBack()} name='arrow-back-sharp' size={25} style={{color:"#ffffff",}}/></View>
...
<View className="w-full  h-72 pt-10 bg-white z-30 -mt-5 rounded-3xl   ">
<View className="mx-4 space-y-3">
<View>
<View className="flex-row    bg-teal-700/90  px-4 p-2 rounded-full  ">
